...
```bash
# 下载 tarball
curl -L -o aifr.tgz https://github.com/GeziP/AI-Flight-Recorder/releases/download/v0.1.2/aifr-0.1.2.tgz

# 全局安装
npm i -g aifr.tgz

# 或者直接从 GitHub 安装（无需下载）
npm i -g GeziP/AI-Flight-Recorder
...
```bash
npx aifr import claude          # 导入全部 Claude Code 会话
npx aifr import codex           # 导入全部 Codex CLI 会话
npx aifr import codex --limit 5 # 只导入最近 5 个
```
