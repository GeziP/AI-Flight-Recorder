...
* 发布聚焦的 v0.1 MVP，让开发者能够快速安装、本地运行，并在一个真实编程 session 中完成录制和回放。
...
* 用户主要通过 GitHub 发现 AIFR，第一屏定位必须非常明确：
...
Medium：2–4 周完成聚焦版 v0.1，前提是团队保持小而快，严格避免 RAG、AI Summary、云同步和复杂协作功能。
